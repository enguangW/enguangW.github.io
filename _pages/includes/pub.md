...
<div class='paper-box' style="display: block; margin-bottom: 20px;">
  <div style="width: 100%; margin-bottom: 10px;">
    <a href="https://arxiv.org/pdf/2603.20808" style="font-weight: bold; font-size: 1.1em;">Predictive Regularization Against Visual Representation Degradation in Multimodal Large Language Models</a><br>
    <strong>Enguang Wang</strong>, Qiang Wang, Yuanchen Wu, Ke Yan, Xinbin Yuan, Shouhong Ding, Xialei Liu, Ming-Ming Cheng
  </div>

  <div style="display: flex; align-items: flex-start;">
    <div class='paper-box-image' style="flex: 0 0 45%; min-width: 200px; margin-right: 15px;">
